...
public class ContractController {
    ...
    @PostMapping("/{userId}")
    public ResponseEntity<ApiResponse<CreateContractResponseDto>> createContract(@PathVariable Long userId, @RequestBody CreateContractRequestDto createContractRequestDto) {
