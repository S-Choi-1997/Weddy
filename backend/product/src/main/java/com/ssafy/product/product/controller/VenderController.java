...
public class VenderController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<VenderResponseDto>> registerVender(@Valid @RequestPart VenderRequestDto venderRequestDto, @RequestPart MultipartFile image) {
