...
public class GetScheduleInputPort implements GetScheduleUsecase {
    ...
    @Override
    public List<ScheduleOutputDto> getAllSchedules(UserInputDto userInputDto) throws Exception {
    ...
    @Override
    public ScheduleOutputDto getSchedule(UserInputDto userInputDto) throws Exception {
        return null;
    }
}
